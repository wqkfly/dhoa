package org.ddpush.client.udp.service;

import java.nio.ByteBuffer;

import org.ddpush.client.udp.DateTimeUtil;
import org.ddpush.client.udp.Params;
import org.ddpush.client.udp.Util;
import org.ddpush.client.udp.receiver.TickAlarmReceiver;
import org.ddpush.im.v1.client.appuser.Message;
import org.ddpush.im.v1.client.appuser.UDPClientBase;

import com.dhcc.activity.MyApplication;
...
public class OnlineService extends Service {
	...
	public class MyUdpClient extends UDPClientBase {
		...
		public void onPushMessage(Message message) {
			...
			if(message.getCmd() == 32){// 0x20 自定义推送信息
				...
				notifyUser(32,"东华办公平台",""+str,"收到自定义推送信息");
			}
			setPkgsInfo();
		}
	...
	protected void notifyRunning(){
		...
		n.contentIntent = pi;
		n.setLatestEventInfo(this, "东华办公平台", "正在运行", pi);
		...
		n.icon = R.drawable.cloud;  
		n.when = System.currentTimeMillis();
		n.tickerText = "东华办公平台正在运行";
